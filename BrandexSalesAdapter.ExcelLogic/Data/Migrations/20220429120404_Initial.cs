        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BrandexId = table.Column<int>(type: "int", nullable: false),
                    PhoenixId = table.Column<int>(type: "int", nullable: true),
                    PharmnetId = table.Column<int>(type: "int", nullable: true),
                    StingId = table.Column<int>(type: "int", nullable: true),
                    SopharmaId = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BrandexId = table.Column<int>(type: "int", nullable: false),
                    Name = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    PharmacyClass = table.Column<int>(type: "int", nullable: false),
                    Active = table.Column<bool>(type: "bit", nullable: false),
                    CompanyId = table.Column<int>(type: "int", nullable: false),
                    PharmacyChainId = table.Column<int>(type: "int", nullable: false),
                    Address = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CityId = table.Column<int>(type: "int", nullable: false),
                    PharmnetId = table.Column<int>(type: "int", nullable: true),
                    PhoenixId = table.Column<int>(type: "int", nullable: true),
                    SopharmaId = table.Column<int>(type: "int", nullable: true),
                    StingId = table.Column<int>(type: "int", nullable: true),
